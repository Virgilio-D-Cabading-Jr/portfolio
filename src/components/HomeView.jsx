    ...
    <div className='container'>
      <div className='d-flex flex-column justify-content-center align-items-center text-white text-center' style={{ height: '100vh' }}>
        ...
        <div className=''>
          ...
          <p>Hello, I am a highly motivated Software Developer<br/> transitioning from the healthcare industry with a B.S. in Informatics.  </p>
          {/* My interests are many, but I am currently interested in<br/>expanding my knowledge on building a React.js front-end with various backend frameworks along with DevOps. */}
        </div>
